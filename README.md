...
- Deux pages d'aide accessibles depuis le pied de page : « Le principe »
  (la boucle théorie → pratique → examen, pourquoi 100% pour valider, cadre
  100% simulé) et « Mode d'emploi » (comment utiliser la console, les
  indices, l'examen, la navigation).
- Navigation arrière dans le labo : un bouton « ◂ Retour au principe »
  ramène de la pratique vers la théorie du chapitre, un bouton « ◂ Retour
  au labo » ramène de l'examen vers la pratique, et un bouton « ◂ Étape
  précédente » permet de revenir à l'étape de pratique précédente sans
